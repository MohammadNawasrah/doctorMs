                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="padding-left: 5%;">aseel</td>
                                    <td>
                                        <button class="btn btn-primary" style="margin-left: 4%;" data-toggle="tooltip"
                                            data-placement="top" title="Modify appointments"><i
                                                class="bi bi-pen"></i></button>
                                        <button class="btn btn-success" style="margin-left: 4%;" data-toggle="tooltip"
                                            data-placement="top" title="send" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal"><i class="bi bi-arrow-right"></i></button>
                                        <button class="btn btn-danger" data-toggle="tooltip" style="margin-left: 4%;"
                                            data-placement="top" title="Delete appointment" data-bs-toggle="modal"
                                            data-bs-target="#Modal"><i class="bi bi-calendar-check"></i></button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
