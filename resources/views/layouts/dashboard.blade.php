    ...
    <div class="container-fluid">
        <div class="row" style="height: 100vh;">
            <nav class=" bg-light sidebar shadow" style="height: 100%;width:350px; display:flex; flex-direction: column; ">
                ...
                <!-- <div class="col-md-3" style="margin-left: 40px;display:flex;justify-content: center;align-items: center;"> -->



                <div class="sidebar-sticky">
                    <div style="display: flex;justify-content: center;align-items: center;">
                        <a style="width: 80%;" href="{{ url('/dashboard/logOut') }}" class="btn btn-blue btn-block hover-effect">Log out</a>
