        ...
        <div class="row" style="height: 100vh;">
            ...
            <nav class=" bg-light sidebar shadow"
                ...
                <div class="sidebar-sticky">
                    <div style="display: flex;justify-content: center;align-items: center;"> <a style="width: 80%;"
                            href="{{ url('/dashboard/logOut') }}" class="btn btn-blue btn-block hover-effect">Log
                            out</a> </div>
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item" data-permission="secertarPage">
                            <a class="nav-link hover-link" data-url="patient" href="/dashboard/dateToDay">
                                <div class="menu-btn">
                                    <div class="menu-text sideBarButton"><i class="bi bi-calendar-check"></i> Date To
                                        Day</div>
                                </div>
                            </a>
                        </li>
