    ...
    public function showPatients()
    {
        ...
        foreach ($patients as $patient) {
            ...
            if (in_array($patient["id"], $patientsAppointmentIds) && in_array("updateAppointment", $acctionAllow)) {
                ...
                $table .= '<button class="btn btn-success" data-payment_value="' .  Payments::isPatientNotPay($patient["id"])["must_be_paid"] . '" data-doctor="' . Payments::isPatientNotPay($patient["id"])["fk_record"] . '" data-type="mustHePay" data-token="' . $patient["token"] . '" id="mustPay" style="margin-left: 4%;" data-toggle="tooltip" data-placement="top" title="Must Pay" data-bs-toggle="modal" data-bs-target="#addPay"><i class="bi bi-credit-card"></i></button>';
